...
class TestJsonUnflattenerBuilderPattern:
    ...
    def test_key_replacement(self):
        ...
        unflattener = json_tools_rs.JsonUnflattener().key_replacement("prefix.", "user.")
        result = unflattener.unflatten(flattened)
    ...
    def test_value_replacement(self):
        ...
        unflattener = json_tools_rs.JsonUnflattener().value_replacement("@company.org", "@example.com")
        result = unflattener.unflatten(flattened)
    ...
    def test_regex_key_replacement(self):
        ...
        unflattener = json_tools_rs.JsonUnflattener().key_replacement("regex:^(user|admin)_", "$1.")
        result = unflattener.unflatten(flattened)
