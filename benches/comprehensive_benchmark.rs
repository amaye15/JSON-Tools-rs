            ...
            |b, json_content| {
                b.iter(|| {
                    let result = JSONTools::new()
                        ...
                        .key_replacement("regex:Count", "Cnt")
                        .key_replacement("regex:Amount", "Amt")
                        .key_replacement("regex:Address", "Addr")
                        .value_replacement("regex:^$", "N/A")
                        .value_replacement("regex:null", "NULL")
            ...
            |b, json_content| {
                b.iter(|| {
                    ...
                    let flattened = JSONTools::new()
                        ...
                        .remove_empty_strings(true)
                        .remove_nulls(true)
                        .key_replacement("regex:aggregation", "agg")
                        .key_replacement("regex:transaction", "txn")
                        .value_replacement("regex:^0$", "zero")
                        .handle_key_collision(true)
                        .execute(black_box(json_content))
                        .expect("Comprehensive flatten failed");
                    ...
                    let result = JSONTools::new()
                        .unflatten()
                        .separator(black_box("__"))
                        .key_replacement("regex:agg", "aggregation")
                        .key_replacement("regex:txn", "transaction")
                        .value_replacement("regex:zero", "0")
                        .handle_key_collision(true)
                        .execute(black_box(&flattened_str))
